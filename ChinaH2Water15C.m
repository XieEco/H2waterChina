...
EF_power=csvread('EF_power_15.csv');% 1-2020,2-2030,3-2050,grid power
...
GHG_OU_building(:,1)=P_building(:,1).*0.6505./1000./10^6;%MtCO2eq
GHG_OU_building(:,2)=P_building(:,2).*0.6394./1000./10^6;%MtCO2eq
GHG_OU_building(:,3)=P_building(:,3).*0.6505./1000./10^6;%MtCO2eq
GHG_OU_building(:,4)=P_building(:,4).*0.6394./1000./10^6;%MtCO2eq
GHG_OU_truck(:,1)=P_truck(:,1).*4.1179./10^6+P_truck(:,5).*EF_power(:,2)./10^6;%MtCO2eq
GHG_OU_truck(:,2)=P_truck(:,2).*3.6110./10^6+P_truck(:,6).*EF_power(:,3)./10^6;%MtCO2eq
GHG_OU_truck(:,3)=P_truck(:,3).*4.1179./10^6+P_truck(:,7).*EF_power(:,2)./10^6;%MtCO2eq
GHG_OU_truck(:,4)=P_truck(:,4).*3.6110./10^6+P_truck(:,8).*EF_power(:,3)./10^6;%MtCO2eq
GHG_OU_bus(:,1)=P_bus(:,1).*4.1179./10^6+P_bus(:,5).*EF_power(:,2)./10^6;%MtCO2eq
GHG_OU_bus(:,2)=P_bus(:,2).*3.6110./10^6+P_bus(:,6).*EF_power(:,3)./10^6;%MtCO2eq
GHG_OU_bus(:,3)=P_bus(:,3).*4.1179./10^6+P_bus(:,7).*EF_power(:,2)./10^6;%MtCO2eq
GHG_OU_bus(:,4)=P_bus(:,4).*3.6110./10^6+P_bus(:,8).*EF_power(:,3)./10^6;%MtCO2eq
GHG_OU_car(:,1)=P_car(:,1).*4.0537./10^6+P_car(:,5).*EF_power(:,2)./10^6;%MtCO2eq
GHG_OU_car(:,2)=P_car(:,2).*3.9346./10^6+P_car(:,6).*EF_power(:,3)./10^6;%MtCO2eq
GHG_OU_car(:,3)=P_car(:,3).*4.0537./10^6+P_car(:,7).*EF_power(:,2)./10^6;%MtCO2eq
GHG_OU_car(:,4)=P_car(:,4).*3.9346./10^6+P_car(:,8).*EF_power(:,3)./10^6;%MtCO2eq
GHG_OU_ship(:,1)=P_ship(:,1).*3.8551./10^6;%MtCO2eq
GHG_OU_ship(:,2)=P_ship(:,2).*3.7908./10^6;%MtCO2eq
GHG_OU_ship(:,3)=P_ship(:,3).*3.8551./10^6;%MtCO2eq
GHG_OU_ship(:,4)=P_ship(:,4).*3.7908./10^6;%MtCO2eq
GHG_OU_air(:,1)=P_air(:,1).*3.9588./10^6;%MtCO2eq
GHG_OU_air(:,2)=P_air(:,2).*3.8976./10^6;%MtCO2eq
GHG_OU_air(:,3)=P_air(:,3).*3.9588./10^6;%MtCO2eq
GHG_OU_air(:,4)=P_air(:,4).*3.8976./10^6;%MtCO2eq
GHG_OU_refining(:,1)=P_refining(:,1).*10.5627./10^6;%MtCO2eq
GHG_OU_refining(:,2)=P_refining(:,2).*2.5203./10^6;%MtCO2eq
GHG_OU_refining(:,3)=P_refining(:,3).*10.5627./10^6;%MtCO2eq
GHG_OU_refining(:,4)=P_refining(:,4).*2.5203./10^6;%MtCO2eq
GHG_OU_synfuel(:,1)=P_synfuel(:,1).*10.5627./10^6;%MtCO2eq
GHG_OU_synfuel(:,2)=P_synfuel(:,2).*2.5203./10^6;%MtCO2eq
GHG_OU_synfuel(:,3)=P_synfuel(:,3).*10.5627./10^6;%MtCO2eq
GHG_OU_synfuel(:,4)=P_synfuel(:,4).*2.5203./10^6;%MtCO2eq
GHG_OU_fuel(:,1)=P_fuel(:,1).*0.4813./1000./10^6;%MtCO2eq
GHG_OU_fuel(:,2)=P_fuel(:,2).*0.4698./1000./10^6;%MtCO2eq
GHG_OU_fuel(:,3)=P_fuel(:,3).*0.4813./1000./10^6;%MtCO2eq
GHG_OU_fuel(:,4)=P_fuel(:,4).*0.4698./1000./10^6;%MtCO2eq
...
GHG_PRO_RE(:,j)=D(:,j)./0.95.*FDL_pv(:,1).*(0.083+0.194+0.227+57.9.*0.0425.*mean(CF(:,1))./CF(:,1))./10^6+D(:,j)./0.95.*FDL_wind(:,1).*(0.083+0.194+0.227+57.9.*0.0116.*mean(CF(:,2))./CF(:,2))./10^6;%2030
GHG_PRO_RE(:,j+1)=D(:,j+1)./0.95.*FDL_pv(:,2).*(0.083+0.194+0.227+57.9.*0.0163.*mean(CF(:,1))./CF(:,1))./10^6+D(:,j+1)./0.95.*FDL_wind(:,2).*(0.083+0.194+0.227+57.9.*0.0058.*mean(CF(:,2))./CF(:,2))./10^6;%2050
end
...
if  WC(i,1)==3
    ...
    GHG_S1(i,1)=-GHG_average_counties(i,1).*D_county(i,1)./10^6./0.95+GHG_ideal(i,1)-0.1384./1000.*DIS(i,1).*D_county(i,1)./10^6;
    GHG_S1(i,3)=-GHG_average_counties(i,3).*D_county(i,3)./10^6./0.95+GHG_ideal(i,3)-0.1384./1000.*DIS(i,1).*D_county(i,3)./10^6;
else    
end
if  WC(i,2)==3
    ...
    GHG_S1(i,2)=-GHG_average_counties(i,2).*D_county(i,2)./10^6./0.95+GHG_ideal(i,2)-0.0532./1000.*DIS(i,2).*D_county(i,2)./10^6;
    GHG_S1(i,4)=-GHG_average_counties(i,4).*D_county(i,4)./10^6./0.95+GHG_ideal(i,4)-0.0532./1000.*DIS(i,2).*D_county(i,4)./10^6;
else    
end
end
...
EF_RE(:,1)=FDL_pv(:,1).*(0.0425.*mean(CF(:,1))./CF(:,1))+FDL_wind(:,1).*(0.0116.*mean(CF(:,2))./CF(:,2));%2030
EF_RE(:,2)=FDL_pv(:,2).*(0.0163.*mean(CF(:,1))./CF(:,1))+FDL_wind(:,2).*(0.0058.*mean(CF(:,2))./CF(:,2));%2050
for i=1:2901
    for j=1:4
    if MC(i,j)==1
        if j==1||j==3
...
GHG_S3(:,1)=-(0.0026.*1000./1000.*D_wcT(:,1)./0.95.*32.24)./10^6;%Mt CO2eq
GHG_S3(:,2)=-(0.0005.*1000./1000.*D_wcT(:,2)./0.95.*32.24)./10^6;%Mt CO2eq
GHG_S3(:,3)=-(0.0026.*1000./1000.*D_wcT(:,3)./0.95.*32.24)./10^6;%Mt CO2eq
GHG_S3(:,4)=-(0.0005.*1000./1000.*D_wcT(:,4)./0.95.*32.24)./10^6;%Mt CO2eq
for i=1:2901
    for j=1:4
        if A(i,ceil(j./2))==0
        else
...
GHG_S4(:,1)=-((0.0041.*1000-0.00019)./1000.*D_wcT(:,1)./0.95.*32.24)./10^6;%Mt CO2eq
GHG_S4(:,3)=-((0.0041.*1000-0.00019)./1000.*D_wcT(:,3)./0.95.*32.24)./10^6;%Mt CO2eq
GHG_S4(:,2)=-((0.0029.*1000-0.00019)./1000.*D_wcT(:,2)./0.95.*32.24)./10^6;%Mt CO2eq
GHG_S4(:,4)=-((0.0029.*1000-0.00019)./1000.*D_wcT(:,4)./0.95.*32.24)./10^6;%Mt CO2eq
...
for    j=1:2
    ...
    elseif MC(i,j)==2 
    GHG_el_power(i,j)=GHG_WW_power_RE(i,j)-GHG_PRO_RE(i,j)-H2ST(i,j).*(D_power(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_building(i,j)=GHG_WW_building_RE(i,j)-GHG_PRO_RE(i,j+2)-H2ST(i,j).*(D_building(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_truck(i,j)=GHG_WW_truck_RE(i,j)-GHG_PRO_RE(i,j+4)-H2ST(i,j).*(D_truck(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_bus(i,j)=GHG_WW_bus_RE(i,j)-GHG_PRO_RE(i,j+6)-H2ST(i,j).*(D_bus(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_car(i,j)=GHG_WW_car_RE(i,j)-GHG_PRO_RE(i,j+8)-H2ST(i,j).*(D_car(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_ship(i,j)=GHG_WW_ship_RE(i,j)-GHG_PRO_RE(i,j+10)-H2ST(i,j).*(D_ship(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_air(i,j)=GHG_WW_air_RE(i,j)-GHG_PRO_RE(i,j+12)-H2ST(i,j).*(D_air(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_ammonia(i,j)=GHG_WW_ammonia_RE(i,j)-GHG_PRO_RE(i,j+14)-H2ST(i,j).*(D_ammonia(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_methanol(i,j)=GHG_WW_methanol_RE(i,j)-GHG_PRO_RE(i,j+16)-H2ST(i,j).*(D_methanol(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_oil(i,j)=GHG_WW_oil_RE(i,j)-GHG_PRO_RE(i,j+60)-H2ST(i,j).*(D_oil(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_ng(i,j)=GHG_WW_ng_RE(i,j)-GHG_PRO_RE(i,j+62)-H2ST(i,j).*(D_ng(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_olefin(i,j)=GHG_WW_olefin_RE(i,j)-GHG_PRO_RE(i,j+64)-H2ST(i,j).*(D_olefin(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_eg(i,j)=GHG_WW_eg_RE(i,j)-GHG_PRO_RE(i,j+66)-H2ST(i,j).*(D_eg(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_metallurgy(i,j)=GHG_WW_metallurgy_RE(i,j)-GHG_PRO_RE(i,j+20)-H2ST(i,j).*(D_metallurgy(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_refining(i,j)=GHG_WW_refining_RE(i,j)-GHG_PRO_RE(i,j+26)-H2ST(i,j).*(D_refining(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_fuel(i,j)=GHG_WW_fuel_RE(i,j)-GHG_PRO_RE(i,j+22)-H2ST(i,j).*(D_fuel(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_synfuel(i,j)=GHG_WW_synfuel_RE(i,j)-GHG_PRO_RE(i,j+24)-H2ST(i,j).*(D_synfuel(i,j)./D_county(i,j)).*(0.947+0.*0.00000019)./10^6;        
    else
    end
    if MC(i,j+2)==1
    ...
    GHG_el_synfuel(i,j+2)=GHG_WW_synfuel_grid(i,j+2)-GHG_PRO_grid(i,j+24+30);
        elseif MC(i,j+2)==2
    GHG_el_power(i,j+2)=GHG_WW_power_RE(i,j+2)-GHG_PRO_RE(i,j+30)-H2ST(i,j+2).*(D_power(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_building(i,j+2)=GHG_WW_building_RE(i,j+2)-GHG_PRO_RE(i,j+2+30)-H2ST(i,j+2).*(D_building(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_truck(i,j+2)=GHG_WW_truck_RE(i,j+2)-GHG_PRO_RE(i,j+4+30)-H2ST(i,j+2).*(D_truck(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_bus(i,j+2)=GHG_WW_bus_RE(i,j+2)-GHG_PRO_RE(i,j+6+30)-H2ST(i,j+2).*(D_bus(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_car(i,j+2)=GHG_WW_car_RE(i,j+2)-GHG_PRO_RE(i,j+8+30)-H2ST(i,j+2).*(D_car(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_ship(i,j+2)=GHG_WW_ship_RE(i,j+2)-GHG_PRO_RE(i,j+10+30)-H2ST(i,j+2).*(D_ship(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_air(i,j+2)=GHG_WW_air_RE(i,j+2)-GHG_PRO_RE(i,j+12+30)-H2ST(i,j+2).*(D_air(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_ammonia(i,j+2)=GHG_WW_ammonia_RE(i,j+2)-GHG_PRO_RE(i,j+14+30)-H2ST(i,j+2).*(D_ammonia(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_methanol(i,j+2)=GHG_WW_methanol_RE(i,j+2)-GHG_PRO_RE(i,j+16+30)-H2ST(i,j+2).*(D_methanol(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_oil(i,j+2)=GHG_WW_oil_RE(i,j+2)-GHG_PRO_RE(i,j+60+8)-H2ST(i,j+2).*(D_oil(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_ng(i,j+2)=GHG_WW_ng_RE(i,j+2)-GHG_PRO_RE(i,j+62+8)-H2ST(i,j+2).*(D_ng(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_olefin(i,j+2)=GHG_WW_olefin_RE(i,j+2)-GHG_PRO_RE(i,j+64+8)-H2ST(i,j+2).*(D_olefin(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_eg(i,j+2)=GHG_WW_eg_RE(i,j+2)-GHG_PRO_RE(i,j+66+8)-H2ST(i,j+2).*(D_eg(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_metallurgy(i,j+2)=GHG_WW_metallurgy_RE(i,j+2)-GHG_PRO_RE(i,j+20+30)-H2ST(i,j+2).*(D_metallurgy(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_refining(i,j+2)=GHG_WW_refining_RE(i,j+2)-GHG_PRO_RE(i,j+26+30)-H2ST(i,j+2).*(D_refining(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_fuel(i,j+2)=GHG_WW_fuel_RE(i,j+2)-GHG_PRO_RE(i,j+22+30)-H2ST(i,j+2).*(D_fuel(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    GHG_el_synfuel(i,j+2)=GHG_WW_synfuel_RE(i,j+2)-GHG_PRO_RE(i,j+24+30)-H2ST(i,j+2).*(D_synfuel(i,j+2)./D_county(i,j+2)).*(0.947+0.*0.00000019)./10^6;
    else
    end
end
end
...
FIG3A_wc=GHG_ideal_sector-GHG_ideal_sector_nwc;
FIG3A_nwc=GHG_ideal_sector_nwc;
%sum(GHG_ideal_sector)-sum(GHG_ideal_sector_nwc)
%(sum(GHG_ideal_sector)-sum(GHG_ideal_sector_nwc))./sum(GHG_ideal_sector) 
FIG3b_power=zeros(31,4);
FIG3b_building=zeros(31,4);
FIG3b_transport=zeros(31,4);
FIG3b_industry=zeros(31,4);
for i=1:31
for j=KS(1,i):JS(1,i)
FIG3b_power(i,:)=FIG3b_power(i,:)+GHG_OU_power(j,:)+GHG_el_power(j,:)-GHG_OU_power_nwc(j,:)-GHG_el_power_nwc(j,:);
FIG3b_building(i,:)=FIG3b_building(i,:)+GHG_OU_building(j,:)+GHG_el_building(j,:)-GHG_OU_building_nwc(j,:)-GHG_el_building_nwc(j,:);
FIG3b_transport(i,:)=FIG3b_transport(i,:)+GHG_OU_truck(j,:)+GHG_el_truck(j,:)+GHG_OU_car(j,:)+GHG_el_car(j,:)+GHG_OU_bus(j,:)+GHG_el_bus(j,:)+GHG_OU_ship(j,:)+GHG_el_ship(j,:)+GHG_OU_air(j,:)+GHG_el_air(j,:)-GHG_OU_truck_nwc(j,:)-GHG_el_truck_nwc(j,:)-GHG_OU_car_nwc(j,:)-GHG_el_car_nwc(j,:)-GHG_OU_bus_nwc(j,:)-GHG_el_bus_nwc(j,:)-GHG_OU_ship_nwc(j,:)-GHG_el_ship_nwc(j,:)-GHG_OU_air_nwc(j,:)-GHG_el_air_nwc(j,:);
FIG3b_industry(i,:)=FIG3b_industry(i,:)+GHG_OU_ammonia(j,:)+GHG_el_ammonia(j,:)+GHG_OU_methanol(j,:)+GHG_el_methanol(j,:)+GHG_OU_oil(j,:)+GHG_el_oil(j,:)+GHG_OU_ng(j,:)+GHG_el_ng(j,:)+GHG_OU_olefin(j,:)+GHG_el_olefin(j,:)+GHG_OU_eg(j,:)+GHG_el_eg(j,:)+GHG_OU_metallurgy(j,:)+GHG_el_metallurgy(j,:)+GHG_OU_refining(j,:)+GHG_el_refining(j,:)+GHG_OU_fuel(j,:)+GHG_el_fuel(j,:)+GHG_OU_synfuel(j,:)+GHG_el_synfuel(j,:)-GHG_OU_ammonia_nwc(j,:)-GHG_el_ammonia_nwc(j,:)-GHG_OU_methanol_nwc(j,:)-GHG_el_methanol_nwc(j,:)-GHG_OU_oil_nwc(j,:)-GHG_el_oil_nwc(j,:)-GHG_OU_ng_nwc(j,:)-GHG_el_ng_nwc(j,:)-GHG_OU_olefin_nwc(j,:)-GHG_el_olefin_nwc(j,:)-GHG_OU_eg_nwc(j,:)-GHG_el_eg_nwc(j,:)-GHG_OU_metallurgy_nwc(j,:)-GHG_el_metallurgy_nwc(j,:)-GHG_OU_refining_nwc(j,:)-GHG_el_refining_nwc(j,:)-GHG_OU_fuel_nwc(j,:)-GHG_el_fuel_nwc(j,:)-GHG_OU_synfuel_nwc(j,:)-GHG_el_synfuel_nwc(j,:);
end
end
j=2901;
FIG3b_power(10,:)=FIG3b_power(10,:)+GHG_OU_power(j,:)+GHG_el_power(j,:)-GHG_OU_power_nwc(j,:)-GHG_el_power_nwc(j,:);
FIG3b_building(10,:)=FIG3b_building(10,:)+GHG_OU_building(j,:)+GHG_el_building(j,:)-GHG_OU_building_nwc(j,:)-GHG_el_building_nwc(j,:);
FIG3b_transport(10,:)=FIG3b_transport(10,:)+GHG_OU_truck(j,:)+GHG_el_truck(j,:)+GHG_OU_car(j,:)+GHG_el_car(j,:)+GHG_OU_bus(j,:)+GHG_el_bus(j,:)+GHG_OU_ship(j,:)+GHG_el_ship(j,:)+GHG_OU_air(j,:)+GHG_el_air(j,:)-GHG_OU_truck_nwc(j,:)-GHG_el_truck_nwc(j,:)-GHG_OU_car_nwc(j,:)-GHG_el_car_nwc(j,:)-GHG_OU_bus_nwc(j,:)-GHG_el_bus_nwc(j,:)-GHG_OU_ship_nwc(j,:)-GHG_el_ship_nwc(j,:)-GHG_OU_air_nwc(j,:)-GHG_el_air_nwc(j,:);
FIG3b_industry(10,:)=FIG3b_industry(10,:)+GHG_OU_ammonia(j,:)+GHG_el_ammonia(j,:)+GHG_OU_methanol(j,:)+GHG_el_methanol(j,:)+GHG_OU_oil(j,:)+GHG_el_oil(j,:)+GHG_OU_ng(j,:)+GHG_el_ng(j,:)+GHG_OU_olefin(j,:)+GHG_el_olefin(j,:)+GHG_OU_eg(j,:)+GHG_el_eg(j,:)+GHG_OU_metallurgy(j,:)+GHG_el_metallurgy(j,:)+GHG_OU_refining(j,:)+GHG_el_refining(j,:)+GHG_OU_fuel(j,:)+GHG_el_fuel(j,:)+GHG_OU_synfuel(j,:)+GHG_el_synfuel(j,:)-GHG_OU_ammonia_nwc(j,:)-GHG_el_ammonia_nwc(j,:)-GHG_OU_methanol_nwc(j,:)-GHG_el_methanol_nwc(j,:)-GHG_OU_oil_nwc(j,:)-GHG_el_oil_nwc(j,:)-GHG_OU_ng_nwc(j,:)-GHG_el_ng_nwc(j,:)-GHG_OU_olefin_nwc(j,:)-GHG_el_olefin_nwc(j,:)-GHG_OU_eg_nwc(j,:)-GHG_el_eg_nwc(j,:)-GHG_OU_metallurgy_nwc(j,:)-GHG_el_metallurgy_nwc(j,:)-GHG_OU_refining_nwc(j,:)-GHG_el_refining_nwc(j,:)-GHG_OU_fuel_nwc(j,:)-GHG_el_fuel_nwc(j,:)-GHG_OU_synfuel_nwc(j,:)-GHG_el_synfuel_nwc(j,:);
FIG3b=FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry;
 
FIG3b_bili_power=FIG3b_power./(FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry);
FIG3b_bili_building=FIG3b_building./(FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry);
FIG3b_bili_transport=FIG3b_transport./(FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry);
FIG3b_bili_industry=FIG3b_industry./(FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry);
FIG3b_bili_power_china=sum(FIG3b_power)./(sum(FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry));
FIG3b_bili_building_china=sum(FIG3b_building)./(sum(FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry));
FIG3b_bili_transport_china=sum(FIG3b_transport)./(sum(FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry));
FIG3b_bili_industry_china=sum(FIG3b_industry)./(sum(FIG3b_power+FIG3b_building+FIG3b_transport+FIG3b_industry));
FIG3b_CHINA(1,:)=FIG3b_bili_power_china(1,:);
FIG3b_CHINA(2,:)=FIG3b_bili_building_china(1,:);
FIG3b_CHINA(3,:)=FIG3b_bili_transport_china(1,:);
FIG3b_CHINA(4,:)=FIG3b_bili_industry_china(1,:);
%sum(FIG3b)
%Fig4 
FIG4=zeros(16,4);
FIG4(1,1)=GHGperH2_S1_LAND(1,1);
FIG4(1,2)=GHGperH2_S1_SEA(1,1);
FIG4(2,1)=GHGperH2_S2_LAND(1,1);
FIG4(2,2)=GHGperH2_S2_SEA(1,1);
FIG4(3,1)=GHGperH2_S3_LAND(1,1);
FIG4(3,2)=GHGperH2_S3_SEA(1,1);
FIG4(4,1)=0;
FIG4(4,2)=GHGperH2_S4_SEA(1,1);
FIG4(1,3)=DJ_S1_LAND(1,1);
FIG4(1,4)=DJ_S1_SEA(1,1);
FIG4(2,3)=DJ_S2_LAND(1,1);
FIG4(2,4)=DJ_S2_SEA(1,1);
FIG4(3,3)=DJ_S3_LAND(1,1);
FIG4(3,4)=DJ_S3_SEA(1,1);
FIG4(4,3)=0;
FIG4(4,4)=DJ_S4_SEA(1,1);
 
FIG4(1+4,1)=GHGperH2_S1_LAND(1,2);
FIG4(1+4,2)=GHGperH2_S1_SEA(1,2);
FIG4(2+4,1)=GHGperH2_S2_LAND(1,2);
FIG4(2+4,2)=GHGperH2_S2_SEA(1,2);
FIG4(3+4,1)=GHGperH2_S3_LAND(1,2);
FIG4(3+4,2)=GHGperH2_S3_SEA(1,2);
FIG4(4+4,1)=0;
FIG4(4+4,2)=GHGperH2_S4_SEA(1,2);
FIG4(1+4,3)=DJ_S1_LAND(1,2);
FIG4(1+4,4)=DJ_S1_SEA(1,2);
FIG4(2+4,3)=DJ_S2_LAND(1,2);
FIG4(2+4,4)=DJ_S2_SEA(1,2);
FIG4(3+4,3)=DJ_S3_LAND(1,2);
FIG4(3+4,4)=DJ_S3_SEA(1,2);
FIG4(4+4,3)=0;
FIG4(4+4,4)=DJ_S4_SEA(1,2);
 
FIG4(1+4+4,1)=GHGperH2_S1_LAND(1,3);
FIG4(1+4+4,2)=GHGperH2_S1_SEA(1,3);
FIG4(2+4+4,1)=GHGperH2_S2_LAND(1,3);
FIG4(2+4+4,2)=GHGperH2_S2_SEA(1,3);
FIG4(3+4+4,1)=GHGperH2_S3_LAND(1,3);
FIG4(3+4+4,2)=GHGperH2_S3_SEA(1,3);
FIG4(4+4+4,1)=0;
FIG4(4+4+4,2)=GHGperH2_S4_SEA(1,3);
FIG4(1+4+4,3)=DJ_S1_LAND(1,3);
FIG4(1+4+4,4)=DJ_S1_SEA(1,3);
FIG4(2+4+4,3)=DJ_S2_LAND(1,3);
FIG4(2+4+4,4)=DJ_S2_SEA(1,3);
FIG4(3+4+4,3)=DJ_S3_LAND(1,3);
FIG4(3+4+4,4)=DJ_S3_SEA(1,3);
FIG4(4+4+4,3)=0;
FIG4(4+4+4,4)=DJ_S4_SEA(1,3);
 
FIG4(1+4+4+4,1)=GHGperH2_S1_LAND(1,3+1);
FIG4(1+4+4+4,2)=GHGperH2_S1_SEA(1,3+1);
FIG4(2+4+4+4,1)=GHGperH2_S2_LAND(1,3+1);
FIG4(2+4+4+4,2)=GHGperH2_S2_SEA(1,3+1);
FIG4(3+4+4+4,1)=GHGperH2_S3_LAND(1,3+1);
FIG4(3+4+4+4,2)=GHGperH2_S3_SEA(1,3+1);
FIG4(4+4+4+4,1)=0;
FIG4(4+4+4+4,2)=GHGperH2_S4_SEA(1,3+1);
FIG4(1+4+4+4,3)=DJ_S1_LAND(1,3+1);
FIG4(1+4+4+4,4)=DJ_S1_SEA(1,3+1);
FIG4(2+4+4+4,3)=DJ_S2_LAND(1,3+1);
FIG4(2+4+4+4,4)=DJ_S2_SEA(1,3+1);
FIG4(3+4+4+4,3)=DJ_S3_LAND(1,3+1);
FIG4(3+4+4+4,4)=DJ_S3_SEA(1,3+1);
FIG4(4+4+4+4,3)=0;
FIG4(4+4+4+4,4)=DJ_S4_SEA(1,3+1);
FIG4(:,1:2)=FIG4(:,1:2);
FIG4(:,3:4)=FIG4(:,3:4)./1000;
%-sum(GHG_ideal_sector).*10^6./sum(D_county)
%sum(TC_ideal).*10^6./sum(D_county)
%fig 5
%sum(GHG_ideal_sector)-sum(GHG_ideal_sector_nwc)
%sum(GHG_max_LAND)+sum(GHG_max_SEA)
%sum(GHG_min_LAND)+sum(GHG_min_SEA)
%sum(TC_ideal)
%sum(TC_max_LAND)+sum(TC_max_SEA)
%sum(TC_min_LAND)+sum(TC_min_SEA)
FIG5_GHG_max=zeros(16,4);
FIG5_GHG_max(1:8,:)=GHG_max_LAND(:,:);
FIG5_GHG_max(9:16,:)=GHG_max_SEA(:,:);
FIG5_TC_max=zeros(16,4);
FIG5_TC_max(1:8,:)=TC_max_LAND(:,:);
FIG5_TC_max(9:16,:)=TC_max_SEA(:,:);
FIG5_GHG_min=zeros(16,4);
FIG5_GHG_min(1:8,:)=GHG_min_LAND(:,:);
FIG5_GHG_min(9:16,:)=GHG_min_SEA(:,:);
FIG5_TC_min=zeros(16,4);
FIG5_TC_min(1:8,:)=TC_min_LAND(:,:);
FIG5_TC_min(9:16,:)=TC_min_SEA(:,:);
FIG5_baseline_CHYperGHG=sum(TC_ideal)./sum(GHG_ideal).*1000;%CNY/tCO2
TC_wc_ideal=zeros(2901,4);
for i=1:2901
for    j=1:4
    if WC(i,1)==3
        TC_wc_ideal(i,1)=TC_ideal(i,1);
        TC_wc_ideal(i,3)=TC_ideal(i,3);       
    else
    end
    if WC(i,2)==3
        TC_wc_ideal(i,2)=TC_ideal(i,2);
        TC_wc_ideal(i,4)=TC_ideal(i,4);
    else
    end    
end
end
FIG5_WC_max_CHYperGHG=(sum(FIG5_TC_max)+sum(TC_wc_ideal))./(sum(FIG5_GHG_max)).*1000;%CNY/tCO2
FIG5_WC_min_CHYperGHG=(sum(FIG5_TC_min)+sum(TC_wc_ideal))./(sum(FIG5_GHG_min)).*1000;%CNY/tCO2
TC_wc_LAND_ideal=zeros(2901,4);
TC_wc_SEA_ideal=zeros(2901,4);
for i=1:2901
    for j=1:2
    if A(i,j)==1%0-No constrained;1-coastal;2-Land
        TC_wc_SEA_ideal(i,j)=TC_wc_ideal(i,j);
        TC_wc_SEA_ideal(i,j+2)=TC_wc_ideal(i,j+2);
    elseif A(i,j)==2
        TC_wc_LAND_ideal(i,j)=TC_wc_ideal(i,j);
        TC_wc_LAND_ideal(i,j+2)=TC_wc_ideal(i,j+2);
    else
    end
    end
end
FIG5_WC_LAND_max_CHYperGHG=(sum(TC_max_LAND)+sum(TC_wc_LAND_ideal))./sum(GHG_max_LAND).*1000;%CNY/tCO2
FIG5_WC_SEA_max_CHYperGHG=(sum(TC_max_SEA)+sum(TC_wc_SEA_ideal))./sum(GHG_max_SEA).*1000;%CNY/tCO2
FIG5_WC_LAND_min_CHYperGHG=(sum(TC_min_LAND)+sum(TC_wc_LAND_ideal))./sum(GHG_min_LAND).*1000;%CNY/tCO2
FIG5_WC_SEA_min_CHYperGHG=(sum(TC_min_SEA)+sum(TC_wc_SEA_ideal))./sum(GHG_min_SEA).*1000;%CNY/tCO2
%fig 6
FIG6a=CHOICE(:,2);
FIG6b=CHOICE2(:,2);
