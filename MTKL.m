...
C_electrolyzer=C_electrolyzer.*randi([4000,20000], 1)./10000;
...
C_battery=C_battery.*randi([4000,20000], 1)./10000;
...
C_pv=C_pv.*randi([4000,20000], 1)./10000;
...
C_wind=C_wind.*randi([4000,20000], 1)./10000;
...
GHG_S3=-(15.32./1000.*D_wc./0.95.*32.24)./10^6;%Mt CO2eq
...
GHG_S4=-((4.55-0.00019)./1000.*D_wc./0.95.*32.24)./10^6;%Mt CO2eq
...
if  WC(i,1)==3
    ...
    GHG_S1(i,1)=-GHG_average_counties(i,1).*D_county(i,1)./10^6./0.95+GHG_ideal(i,1)-0.049./1000.*DIS(i,1).*D_county(i,1)./10^6;
    GHG_S1(i,3)=-GHG_average_counties(i,3).*D_county(i,3)./10^6./0.95+GHG_ideal(i,3)-0.049./1000.*DIS(i,1).*D_county(i,3)./10^6;
else    
end
if  WC(i,2)==3
    ...
    GHG_S1(i,2)=-GHG_average_counties(i,2).*D_county(i,2)./10^6./0.95+GHG_ideal(i,2)-0.049./1000.*DIS(i,2).*D_county(i,2)./10^6;
    GHG_S1(i,4)=-GHG_average_counties(i,4).*D_county(i,4)./10^6./0.95+GHG_ideal(i,4)-0.049./1000.*DIS(i,2).*D_county(i,4)./10^6;
else    
end
end
for i=1:2901
...
GHG_S2(i,1)=GHG_ideal(i,1)-GHG_average_china(1,1).*D_county(i,1)./10^6./(0.95-0.00004.*652)-((0.71./10^3.*10^9+0.426./10^6.*10^9.*652+0.24./10^6.*10^9).*EF_ppl(i,1)+652.*0.24./10^12.*10^9).*D_county(i,1)./10^6./(0.95-0.00004.*652);
GHG_S2(i,3)=GHG_ideal(i,3)-GHG_average_china(1,3).*D_county(i,3)./10^6./(0.95-0.00004.*652)-((0.71./10^3.*10^9+0.426./10^6.*10^9.*652+0.24./10^6.*10^9).*EF_ppl(i,3)+652.*0.24./10^12.*10^9).*D_county(i,3)./10^6./(0.95-0.00004.*652);
else
end
if  WC(i,2)==3
...
GHG_S2(i,2)=GHG_ideal(i,2)-GHG_average_china(1,2).*D_county(i,2)./10^6./(0.95-0.00004.*652)-((0.71./10^3.*10^9+0.426./10^6.*10^9.*652+0.24./10^6.*10^9).*EF_ppl(i,2)+652.*0.24./10^12.*10^9).*D_county(i,2)./10^6./(0.95-0.00004.*652);
GHG_S2(i,4)=GHG_ideal(i,4)-GHG_average_china(1,4).*D_county(i,4)./10^6./(0.95-0.00004.*652)-((0.71./10^3.*10^9+0.426./10^6.*10^9.*652+0.24./10^6.*10^9).*EF_ppl(i,4)+652.*0.24./10^12.*10^9).*D_county(i,4)./10^6./(0.95-0.00004.*652);
else
end
end
for i=1:2901
...
figure
subplot(1,2,1)
hb = boxplot(MTKL_COST(:,1:4),'Colors','k','Symbol','.','Whisker',20);
...
ylim([0,250]);
xticklabels({'2030','2050','2030','2050'});
     % 字体和字号
...
set(gca,'TickDir','out');
hm=findobj(gca,'Tag','Lower Whisker');
set(hm,'LineStyle','-');
hm=findobj(gca,'Tag','Upper Whisker');
set(hm,'LineStyle','-');
box off
h=findobj(gca,'Tag','Box');
for j=1:length(h)
patch(get(h(j),'XData'),get(h(j),'YData'),'c','FaceAlpha',0.6)
end
subplot(1,2,2)
hb = boxplot(MTKL_COST(:,5:8),'Colors','k','Symbol','.','Whisker',20);
set(hb,'LineWidth',1.5)
set(gca, 'Box', 'on', ...                                         
         'LineWidth', 1,...                                      
         'XGrid', 'off', 'YGrid', 'off', ...                      
